...
def get_html_tbody(page_number = 1):
    ...
    # 크롤링할 웹 페이지 URL
    url = "https://www.gwanak.go.kr/site/gwanak/ex/bbsNew/List.do?typeCode=4"
...
def extract_post_data(title, date, link):
    ...
    link = link[12:17]
    full_url = 'https://www.gwanak.go.kr/site/gwanak/ex/bbsNew/View.do?not_ancmt_mgt_no=' + link + '&typeCode=4'
